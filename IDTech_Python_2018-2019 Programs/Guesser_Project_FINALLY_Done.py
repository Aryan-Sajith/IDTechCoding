...
'''Finally greets the user for utilizing the tool ... I am sorry for the extra lines at the end,
 it helps to put an oval around the entire last part otherwise there was not enough space.'''
